...
원고는 완성했지만, 실제 입문자들이 내가 쓴 책을 쉽게 볼 수 있을지를 검토해야했습니다.
...
라이브러리 버전과는 관계없이, IDE나 OS환경이 바뀌었을 경우에는 책을 위해 별도로 구성한 웹 사이트(https://django.ac) 에서 알려드리려고 합니다.

> 이 도메인은 앞으로 최소 10년간 사용할 수 있도록 미리 구매해놓았습니다.
...
![스크린샷 2023-09-03 오후 3.14.02](../../images/2023-09-03-lhy-django/스크린샷 2023-09-03 오후 3.14.02.png)
...
> **https://github.com/django-ac**
>
> ![django8](../../images/2023-09-03-lhy-django/django8.png)

> 각 챕터별로 구분 된 다운로드 링크  
> ![django9](../../images/2023-09-03-lhy-django/django9.png)
